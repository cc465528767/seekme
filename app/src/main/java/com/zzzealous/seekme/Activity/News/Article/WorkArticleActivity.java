...
public class WorkArticleActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    Button back;
    ListView listView;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case GET_VISIBLE_COMMENT :
                    ...
                    Intent intent = new Intent(WorkArticleActivity.this, ArticleDetailActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_work_article);
    ...
    private void initView() {
        back = findViewById(R.id.work_backbtn);
        listView = findViewById(R.id.work_article_listview);

        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                WorkArticleActivity.this.finish();
            }
        });
    }
    ...
    private void getData() {
        ...
        Log.d("为什么出来", "getData: "+ GlobalValues.ArticleList.toString());

    }

    private void setAdapter() {
        articleAdapter = new ArticleAdapter(WorkArticleActivity.this,data);
