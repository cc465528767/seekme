...
public class MemberTraceActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    private List<TraceRecord> data = new ArrayList<>();//获取数据
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_member_trace);
    ...
    private void initView() {
        title = findViewById(R.id.member_trace_title);
        title.setText(titlename + "的巡检记录");


        memberBack = findViewById(R.id.member_backbtn1);
        mListView = (ListView) findViewById(R.id.member_trace_listview);
    ...
    public void getData() {
        DatabaseManager.getInstance().getAllRunRecord(userid, this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.member_backbtn1:
                MemberTraceActivity.this.finish();
                break;
        }
    }

    private void setAdapter() {
        mAdapter = new TraceRecordAdapter(getApplicationContext(), data);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        TraceDialog dia = new TraceDialog(MemberTraceActivity.this, data.get(position).getDate(),
