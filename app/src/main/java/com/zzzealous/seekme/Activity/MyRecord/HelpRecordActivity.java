...
public class HelpRecordActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    private void initView() {
        trace_back = (Button) findViewById(R.id.help_backbtn);
        mListView = (ListView) findViewById(R.id.help_record_listview);
    ...
    private void setAdapter() {
        mAdapter = new SosRecordAdapter(HelpRecordActivity.this, data);
    ...
    private void showSosDialog(int position) {
        ...
        ShowSosDialog dia = new ShowSosDialog(HelpRecordActivity.this, data.get(position).getDate(),
