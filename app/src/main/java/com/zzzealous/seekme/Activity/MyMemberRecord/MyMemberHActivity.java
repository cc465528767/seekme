...
public class MyMemberHActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    public static final int START_MY_MEMBER_HELP_ACTIVTIY = 0x00;
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case START_MY_MEMBER_HELP_ACTIVTIY:
                    Intent intent = new Intent(MyMemberHActivity.this, MemberHelpActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_member_h);
    ...
    private void initView() {
        member_back = findViewById(R.id.member_backbtn2);
        mListView = findViewById(R.id.my_member_listview2);
...
//        DatabaseManager.getInstance().getAllHelpRecord(data.get(position).getUserId());
//
        name = data.get(position).getName();
//        handler.postDelayed(new Runnable() {
//            @Override
//            public void run() {
//            handler.sendEmptyMessage(START_MY_MEMBER_HELP_ACTIVTIY);
//            }
//        },300);
        Intent intent = new Intent(MyMemberHActivity.this, MemberHelpActivity.class);
